...
static const char col_cyan[]        = "#775383";
...
static const Layout layouts[] = {
	...
	{ "===",      bstackhoriz }, /* horizontal bottomstack layout */
};
...
static const char *screenshot[] = { "scrot", "'/home/tori/Pictures/Screenshots/%Y-%m-%d-%H%M%S_$wx$h.png'", NULL };
